        ...
        <div class="p-3 sm:p-5 border-t border-gray-100 bg-white rounded-b-2xl">
          <div class="flex items-end space-x-2 sm:space-x-3">
            <div class="flex-1 min-w-0">
              <textarea id="chatInput" rows="1" placeholder="اسأل عن أي خدمة وحدة معالجة الإخراج..." 
  ...
  showGenericResponse() {
    this.addMessage(
      ...
      <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
        <p class="text-gray-700 text-sm mb-3 arabic-text">يمكنني مساعدتك في هذه الخدمات من وحدة معالجة الإخراج:</p>
      ...
      this.addMessage(
        ...
        <div class="bg-white p-4 rounded-2xl rounded-bl-sm shadow-sm border border-gray-100">
          <p class="text-gray-800 text-sm leading-relaxed mb-4 arabic-text">
            ...
            <strong class="text-emerald-600">جميع خدمات وحدة معالجة الإخراج في السعودية</strong>.
          </p>
